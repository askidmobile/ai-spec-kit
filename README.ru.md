...
- `TASKS.md` — стартовый трекер с правильной структурой таблиц (архивный
  `TASKS_ARCHIVE.md` создаётся командой `/tasks archive`)
...
чтобы ни один файл не рос бесконечно. Для проекта, заведённого раньше:
`/tasks migrate-archive` разово выносит старые секции `## ✅ …` из самого файла.
